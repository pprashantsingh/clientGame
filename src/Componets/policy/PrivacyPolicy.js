...
const PrivacyPolicy = ({ setTermsModal }) => {
  ...
  return (
    <div className="privacy-container">
      ...
      <p>
        ROCKETPE (Formerly known as ROCKETPE, a sister concern Company for BLAKROCK NANOTECH)
        ("ROCKETPE," the "Company," "we," "us," and "our") respects your privacy and is committed
        to protecting it through its compliance with its privacy policies.
      </p>
      ...
      <h2>Contact Us</h2>
      <p>
        For any queries regarding our privacy policy, payments, or technical issues, please contact us at:
      </p>
      <p>Email: <a href="mailto:therocketpe@gmail.com">therocketpe@gmail.com</a></p>
