...
const PrivacyPolicy = ({ setTermsModal }) => {
  ...
  <p>
    ROCKETBET
 (Formerly known as ROCKETBET sister concern Company for BLAKROCK NANOTECH) 
    ("ROCKETBET
," the "Company," "we," "us," and "our,") respect your privacy and is committed to protecting it through its compliance with its privacy policies. 
    This policy describes:
  </p>
  <ul>
    <li>
      the types of information that ROCKETBET
 may collect from you when you access or use its websites, applications and other online services (collectively, referred as "Services");
    </li>
    <li>
  ...
  <p>
    This policy applies only to the information ROCKETBET
 collects through its Services, in email, text and other electronic communications sent through or in connection with its Services. 
    This policy DOES NOT apply to information that you provide to, or that is collected by, any third-party, such as restaurants at which you make reservations and/or pay through ROCKETBET
's Services and social networks that you use in connection with its Services. 
    ROCKETBET
 encourages you to consult directly with such third-parties about their privacy practices.
  </p>
  <p>
    Please read this policy carefully to understand ROCKETBET
's policies and practices regarding your information and how ROCKETBET
 will treat it. By accessing or using its Services and/or registering for an account with ROCKETBET
, you agree to this privacy policy and you are consenting to ROCKETBET
's collection, use, disclosure, retention, and protection of your personal information as described here. If you do not provide the information ROCKETBET
 requires, ROCKETBET
 may not be able to provide all of its Services to you.
  </p>
  <p>
    Your data controller is responsible for the collection, use, disclosure, retention, and protection of your personal information in accordance with its privacy standards as well as any applicable national laws. Your data controller may transfer data to other members of ROCKETBET
 as described in this Privacy Policy. ROCKETBET
 may process and retain your personal information on its servers in India where its data centers are located, and/or on the servers of its third parties (in or outside India), having contractual relationships with ROCKETBET
.
  </p>
  <p>
    This policy may change from time to time, your continued use of ROCKETBET
's Services after it makes any change is deemed to be acceptance of those changes, so please check the policy periodically for updates.
  </p>
  <h2>The information we collect and how we use it</h2>
  <p>
    ROCKETBET
 ("ROCKETBET
," the "Company," "we," "us," and "our”) collects several types of information from and about users of our Services, including:
  </p>
  <ul>
  ...
  <ul>
    ...
    <li>Stored information and files: Our applications also may access metadata and other information associated with other files stored on your mobile device. This may include, for example, photographs, audio and video clips, personal contacts and address book information.</li>
    ...
    <li>Last URL visited: The URL of the last web page you visited before visiting our websites.</li>
    ...
    <li>Applications: If you use the ROCKETBET
 application, ROCKETBET
 may collect information about the presence and/ or absence and/ or details pertaining to other applications on your mobile phone. The applications we gather information for, may vary across categories including, without limitation, shopping, fashion, food and travel. This will help us understand you and your preferences better and enable ROCKETBET
 to provide you with a personalized experience.</li>
  </ul>
  <h2>Precise Location Information and How to Opt Out</h2>
  <p>
  ...
  <h2>Contact Us</h2>
  <p>
    If you have any queries relating to the processing/ usage of information/Payments/Refunds/ Technical Issues…Etc. provided by you or ROCKETBET
 Privacy Policy, you may email at  (therocketbet@gmail.com,) or write to us at the following address – (Street 23/21, Block-B, Patel Nagar-ND-08). Our Team will solve Your Query As soon as Possible with Immediate Effects.
  </p>
  <p>
        Email: <a href="mailto:therocketbet@gmail.com">therocketbet@gmail.com</a>
      </p>
      <p>
       Support Email: <a href="mailto:support@rocketbet.club">support@rocketbet.club</a>
      </p>
      <p>Address: Street 23/21, Block-B, Patel Nagar-ND-08</p>
      <p className="rocket-policy">Thanks & Regards</p>
  <p className="rocket-policy"><strong>ROCKETBET
</strong></p>
